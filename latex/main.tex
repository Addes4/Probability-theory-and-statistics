...
Felet kvadreras för att göra alla avvikelser positiva (så att positiva och negativa fel inte tar ut varandra), ge större vikt åt stora fel än små, och göra funktionen matematiskt hanterbar med en unik minimumpunkt.
...
\begin{enumerate}
\item \textbf{QR-faktorisering:} Funktionen använder QR-faktorisering för att lösa normalekvationerna numeriskt stabilt, istället för att direkt invertera $\mathbf{X}^T\mathbf{X}$.
